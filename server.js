...
<div id="wrap">
  ...
  <div id="ver">v3.17 · Quái LUÔN động (fix animation) + size hợp lý + boss Hầm = Bí Ngô Vương</div>
</div>
<script>
var WW=560, WH=420;
...
dbInit();
server.listen(PORT,()=>console.log('✅ WEBGAME v3.17 (quái luôn động + size logic + boss bí ngô) chạy ở cổng '+PORT));
