...
<div id="wrap">
  ...
  <div id="ver">v3.15 · Paperdoll A: mũ đổi theo cấp (Norman/Bascinet/Morion) + quái animated</div>
</div>
<script>
var WW=560, WH=420;
...
dbInit();
server.listen(PORT,()=>console.log('✅ WEBGAME v3.15 (mũ theo cấp + quái animated) chạy ở cổng '+PORT));
